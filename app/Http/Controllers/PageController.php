...
class PageController extends Controller
{
    ...
    private function getRestockData()
    {
        ...
        $restock = DB::table('tr_restock_items as i')
            ...
            ->select('i.id as asset_id', 'q.id as restock_request_id', 'i.asset_id as asset_item_id','a.name as asset', 'a.photo as asset_photo', 's.name as supplier', 's.logo as supplier_logo',
